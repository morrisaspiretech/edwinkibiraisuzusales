...
export const VEHICLES_DATA: Record<string, VehicleSpec> = {
  ...
  "single-cabin": {
    id: "single-cabin",
    category: "Pickups",
    title: "Isuzu D-Max Single Cab",
    description: "The Isuzu D-Max Single Cab is built for serious work. With its robust ladder-frame chassis, class-leading payload of up to 1,225 kg, and Isuzu's renowned diesel reliability, it is the go-to workhorse for farmers, contractors, and businesses across Kenya.",
    heroImage: "/vehicles/dmax-single.webp",
    gallery: [
      "/vehicles/dmax-single.webp",
    ],
    quickSpecs: {
      engine: "1.9L Turbo Diesel",
    ...
    detailedSpecs: {
      ...
      chassis: {
        suspensionFront: "Independent Double-Wishbone, Torsion Bar Springs, Gas Shock Absorbers, Stabiliser Bar",
        suspensionRear: "Rigid Axle, Semi-Elliptic Leaf Springs, Gas Shock Absorbers",
        brakes: "Front Ventilated Disc, Rear Drum with ABS & EBD",
    ...
    features: [
      ...
      "Dual front airbags",
      "AM/FM Radio with USB & AUX",
      "Power steering",
      "Air conditioning",
      "Tow capacity up to 3,500 kg",
    ],
  },
  ...
  "double-cabin": {
    id: "double-cabin",
    category: "Pickups",
    title: "Isuzu D-Max Double Cab",
    description: "The most popular Isuzu in Kenya, the D-Max Double Cab perfectly bridges work and lifestyle. With seating for 5, a genuine 4WD system, and available in both manual and automatic, it is equally at home on Nairobi highways and challenging off-road terrain. A true all-rounder for the modern Kenyan.",
    heroImage: "/vehicles/dmax-double.webp",
    gallery: [
      "/vehicles/dmax-double.webp",
    ],
    quickSpecs: {
      engine: "3.0L Turbo Diesel",
    ...
    features: [
      ...
      "Leather-appointed seats (higher trims)",
      "Bi-LED Projector Headlights",
      "18-inch Alloy Wheels",
      "Electronic Stability Control (ESC)",
      "Hill Descent Control",
